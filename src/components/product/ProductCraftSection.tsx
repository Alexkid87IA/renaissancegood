            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6 laptop:space-y-8 mb-8 sm:mb-10 laptop:mb-12 xl:mb-16">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 md:gap-6 laptop:gap-6 xl:gap-12 pt-2 sm:pt-3 laptop:pt-4">
                  ...
                  <div className="space-y-1.5 sm:space-y-2">
                    <p className="font-display text-3xl sm:text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight">250</p>
                    <p className="font-sans text-white/70 text-[9px] sm:text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
                      Étapes de<br/>fabrication
                    </p>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2">
                    <p className="font-display text-3xl sm:text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight whitespace-nowrap">8-15h</p>
                    <p className="font-sans text-white/70 text-[9px] sm:text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
                      De travail<br/>cumulé
                    </p>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2">
                    <p className="font-display text-3xl sm:text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight">2</p>
                    <p className="font-sans text-white/70 text-[9px] sm:text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
