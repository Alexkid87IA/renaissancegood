...
export default function FabricationSection() {
  ...
  return (
    <motion.section
      ref={sectionRef}
      style={{ scale, opacity }}
      className="min-h-screen laptop:h-screen sticky top-0 z-50"
      id="fabrication"
    >
      <div className="relative min-h-screen laptop:h-full overflow-hidden">
        ...
        <div className="relative min-h-screen laptop:h-full flex items-center px-8 md:px-12 lg:px-16 laptop:px-20 max-w-[1920px] mx-auto py-20 laptop:py-0">
          <div className="max-w-3xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-display text-[2.75rem] md:text-5xl lg:text-6xl laptop:text-7xl xl:text-[9rem] font-bold text-white mb-6 laptop:mb-10 xl:mb-12 tracking-[-0.04em] leading-[0.95]">
                FABRICATION
              </h2>

              <div className="space-y-6 laptop:space-y-10 mb-10 laptop:mb-14 xl:mb-16">
                <p className="font-sans text-white text-base md:text-lg laptop:text-lg xl:text-2xl leading-[1.7] font-light max-w-2xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 laptop:gap-8 xl:gap-12 pt-3 laptop:pt-6">
                  <div className="space-y-2">
                    <p className="font-display text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight">8-12</p>
                    <p className="font-sans text-white/70 text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
                      Artisans<br/>par paire
                    </p>
                  </div>
                  <div className="space-y-2">
                    <p className="font-display text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight">250</p>
                    <p className="font-sans text-white/70 text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
                      Étapes de<br/>fabrication
                    </p>
                  </div>
                  <div className="space-y-2">
                    <p className="font-display text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight whitespace-nowrap">8-15h</p>
                    <p className="font-sans text-white/70 text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
                      De travail<br/>cumulé
                    </p>
                  </div>
                  <div className="space-y-2">
                    <p className="font-display text-[2.25rem] md:text-4xl laptop:text-4xl xl:text-6xl text-white font-bold tracking-tight">2</p>
                    <p className="font-sans text-white/70 text-[10px] tracking-[0.15em] uppercase leading-[1.5] font-medium">
              ...
              <div className="space-y-2 laptop:space-y-3 xl:space-y-4 mb-8 laptop:mb-12 xl:mb-16 max-w-2xl">
                <div className="flex items-start gap-4 group">
                  ...
                  <p className="font-sans text-white text-[13px] md:text-sm laptop:text-sm xl:text-lg leading-[1.55] font-light">
