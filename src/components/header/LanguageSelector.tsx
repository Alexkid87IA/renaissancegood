...
export default function LanguageSelector({
  ...
  return (
    ...
    >
      <button className={`font-sans text-[9px] laptop:text-[9.5px] xl:text-[10px] 2xl:text-[10.5px] tracking-[0.25em] font-medium transition-colors duration-500 uppercase leading-none ${
        transparent
