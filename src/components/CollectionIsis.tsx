      ...
      <div className="h-full bg-beige flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 flex items-center justify-center p-12 md:p-16 lg:p-20 laptop:p-20">
          <div className="max-w-2xl">
            <div className="mb-8">
              <h3 className="font-display text-6xl md:text-7xl lg:text-7xl laptop:text-7xl xl:text-8xl font-bold tracking-[-0.03em] leading-[0.9] mb-6">
                COLLECTION<br />ISIS
              </h3>
              <span className="inline-block bg-dark-text/5 border border-dark-text/15 text-dark-text/50 text-[9px] px-5 py-2.5 tracking-[0.25em] font-bold uppercase">
                En Développement
              </span>
            </div>
            ...
            <button className="border-2 border-dark-text/25 px-10 laptop:px-12 py-4 laptop:py-5 font-sans text-[10px] tracking-[0.25em] font-bold text-dark-text/30 cursor-not-allowed">
              BIENTÔT DISPONIBLE
            </button>
          </div>
        </div>
