...
export const TRANSLATIONS: Partial<Record<Exclude<Lang, 'fr'>, EditorialTranslations>> = {
  ...
  "hi": {
    "models": {
      ...
      "Renaissance III": {
        "legende": "वही aviator, कोने दर कोने फिर से गढ़ा।",
      ...
      "Renaissance XVI": {
        "legende": "एक अंडाकार रिमलेस, डायमंड कट में तराशा।",
      ...
      "Renaissance XX": {
        ...
        "description": "अष्टकोण, एसीटेट में मोटा तराशा हुआ। आठ भुजाएँ लेंस को जकड़ती हैं, एक भी झुकती नहीं। टांग पर, सोने की एक रेखा सामग्री में उतरती है। कोई प्रतीक नहीं: चेहरा अकेला।",
        "morphologie": "पतले से मध्यम चेहरों के लिए।"
      },
      "Renaissance XXI": {
      ...
      "Renaissance XXX": {
        ...
        "description": "वह पता जिसे तुम साथ ले जाते हो। Avenue de la Renaissance, सोने में उकेरा हुआ, टांग में जड़ा हुआ। उसके चारों ओर, मोटे एसीटेट का एक आयत, कोने साफ़ कटे। लेंस सामग्री में बैठता है और वहीं टिका रहता है।",
        "morphologie": "मध्यम चेहरों के लिए।"
      },
      "Renaissance XXII": {
        "legende": "ऊपर सीधा थमा हुआ, नीचे नंगा लेंस।",
        "description": "सीधा माथा। धातु की एक बार ऊपर को बंद करती है; नीचे, सामग्री रुक जाती है और एक तार नंगे लेंस को थामता है। कोई प्रतीक नहीं: चेहरा अकेला।",
        "morphologie": "मध्यम से चौड़े चेहरों के लिए।"
      },
      "Renaissance XXVII": {
        "legende": "चौकोर navigator, तीन नोकों से थमा हुआ।",
        "description": "पहले निशान। हर कनपटी पर तीन नोकें धातु से निकलकर लेंस को थामती हैं: Trident फ़्रेम को सजाता नहीं, उसे थामता है। फिर रेखा, एक चौकोर navigator, सीधा डबल ब्रिज, लेंस का निचला हिस्सा साफ़ कटा।",
        "morphologie": "मध्यम से चौड़े चेहरों के लिए।"
      },
      "Renaissance XXIX": {
